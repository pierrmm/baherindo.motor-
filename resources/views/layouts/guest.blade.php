            ...
            <div class="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 relative overflow-hidden">
                ...
                <div class="relative z-10 flex flex-col justify-center items-center w-full p-12 text-white">
                    ...
                    <div class="flex items-center mb-8">
                        ...
                        <div>
                            <h1 class="text-3xl font-bold">Baherindo Motor</h1>
                            <p class="text-blue-100">Jual Beli Motor Terpercaya</p>
                        </div>
                    </div>
                    ...
                    <div class="max-w-md space-y-6">
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100 text-sm">Setiap motor telah melalui inspeksi menyeluruh untuk memastikan kualitas terbaik</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold mb-1">Harga Kompetitif</h3>
                                <p class="text-blue-100 text-sm">Dapatkan motor bekas dengan harga terbaik di pasaran</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <h3 class="text-lg font-semibold mb-1">Pelayanan 24/7</h3>
                                <p class="text-blue-100 text-sm">Tim customer service kami siap membantu Anda kapan saja</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="bg-white bg-opacity-10 backdrop-blur-sm rounded-xl p-6">
                            <div class="flex items-center mb-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-blue-100 text-sm">Pelanggan Setia</p>
                                </div>
                            </div>
                            <p class="text-blue-100 italic">"Pelayanan yang sangat memuaskan! Motor yang saya beli kondisinya sangat baik dan sesuai dengan deskripsi. Highly recommended!"</p>
                            <div class="flex mt-3">
